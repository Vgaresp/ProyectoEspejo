    ...
    private void setupbd() {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener(){ //para logear
            ...
            public void onClick(View v) {
                ...
                if(!inputName.isEmpty() || !inputPassword.isEmpty()){ //si el nombre y la contraseña están introducidos
                ...
                //si alguno de los dos campos está vacio
                ...
                if(!isEmailValid(inputName)){
                    Toast.makeText(LoginActivity.this, "Inserta tu email por favor", Toast.LENGTH_SHORT).show();
                }
            }
        });
